...
JOIN shippers ON shippers.shipper_id = ship_via
...
WHERE products.discontinued < 1 AND products.units_in_stock < 25 AND (categories.category_name = 'Dairy Products' OR categories.category_name = 'Condiments')
