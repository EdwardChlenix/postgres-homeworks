...
SELECT MAX(unit_price), MIN(unit_price) FROM products WHERE discontinued NOT IN ('1')
...
SELECT MAX(unit_price), MIN(unit_price) FROM products WHERE discontinued NOT IN ('1') AND units_in_stock > 20